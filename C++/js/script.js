...
function optionSelected(answer) {
    ...
    if (userAns == correcAns) { //if user selected option is equal to array's correct answer
        ...
        console.log("Your correct answers = " + CPPuserscore);
...
function showResult() {
    ...
    if (CPPuserscore > 3) {
        ...
        let scoreTag = '<span>and congrats! 🎉, You got <p>' + CPPuserscore + '</p> out of <p>' + questions.length + '</p></span><span><p>\nyou are a advanced.</span>';
        scoreText.innerHTML = scoreTag;
        document.getElementById("helpreplacement").innerHTML = questions[que_count].help;

    }
    else if (CPPuserscore > 1) {
        let scoreTag = '<span>and nice 😎, You got <p>' + CPPuserscore + '</p> out of <p>' + questions.length + '</p></span><span><p>\you are intermediate.</span>';
        scoreText.innerHTML = scoreTag;
    }
    else {
        let scoreTag = '<span>and sorry 😐, You got only <p>' + CPPuserscore + '</p> out of <p>' + questions.length + '</p></span><span><p>\nyou are a begginer.</span>';
        scoreText.innerHTML = scoreTag;
    }
}
