...
function optionSelected(answer) {
    ...
    if (userAns == correcAns) { //if user selected option is equal to array's correct answer
        ...
        console.log("Your correct answers = " + SQLuserscore);
...
function push_to_results(incorrect_) {
    for (i = 0; i < incorrect_.lenth; i++) {
        let fill = '<div class="nothing_yet"><span>' + incorrect_[i] + '</span></div>'//creating new span and div tags for every incorrect answer.
...
function showResult() {
    ...
    if (SQLuserscore > 3) {
        ...
        let scoreTag = '<span>and congrats! 🎉, You got <p>' + SQLuserscore + '</p> out of <p>' + questions.length + '</p></span><span><p>\nyou are a advanced.</span>';
        scoreText.innerHTML = scoreTag;
        document.getElementById("helpreplacement").innerHTML = questions[que_count].help;

    }
    else if (SQLuserscore > 1) {
        let scoreTag = '<span>and nice 😎, You got <p>' + SQLuserscore + '</p> out of <p>' + questions.length + '</p></span><span><p>\you are intermediate.</span>';
        scoreText.innerHTML = scoreTag;
    }
    else {
        let scoreTag = '<span>and sorry 😐, You got only <p>' + SQLuserscore + '</p> out of <p>' + questions.length + '</p></span><span><p>\nyou are a begginer.</span>';
        scoreText.innerHTML = scoreTag;
    }
}
